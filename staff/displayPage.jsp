  ...
  <!---Main Division to write code-->
                         ...
                         <div class="container">
                            ...
                            <%
                                    ...
                                    sql="select registerstaff.name,time from accept,registerstaff where reqid='"+request.getParameter("reqid")+"' and registerstaff.staffid='"+to1+"';";
                                    rs=st.executeQuery(sql);
                                    while(rs.next())
                                    {
                                        String staffname=rs.getString("name");
                                        String acceptTime=rs.getString("time");
                                        out.println("Accepted by "+ staffname +" at "+ acceptTime +"<br/>");
                                    }
                                 %>
                                 <hr>
                            </div>
