                           ...
                           <div class="container col-lg-8">
                               ...
                               <%
                                   String strin="";
                                    ...
                                    sql="SELECT distinct * FROM forward,requestsub where forward.staffid='"+session.getAttribute("staffid")+"' and forward.reqid=requestsub.reqid";
                                     strin="displayPage.jsp";
                                   
                                   
                                   ResultSet rs=st.executeQuery(sql);
                               out.println("<table class='table table-bordered'><tr><th>Request ID</th><th> Subject</th><th>Forwarded Time</th></tr>");
                        while(rs.next()){
