    ...
    <body>
        <div >
            ...
            <div class="bodyBackgr" style="height: 200px;">
                <div class="container"><br/><h1><br/>Accepted Requests</h1></div> 
            </div>
            <!--Body Content-->
                ...
                <div class="container" >
                               ...
                               <br/>
                                   ...
                                   String strin="";
                                    ...
                                    sql="SELECT * FROM requestsub where fromStud='"+session.getAttribute("roll")+"'  AND reqstatus=4";
                                     strin="displayPageStud.jsp";
